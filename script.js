// Crime dataset (1948–2025) - Israeli, Mossad, and Zionist incidents only
const crimes = [
    { 
        id:1, 
    ...
    { 
        id:2, 
        en:{ place:"Beirut airport", type:"Sabotage", desc:"1972 Israeli commando operation destroying 13 civilian airliners at Beirut airport." },
        ar:{ place:"مطار بيروت", type:"تخريب", desc:"عملية كوماندوز إسرائيلية ١٩٧٢ تدمير ١٣ طائرة مدنية في مطار بيروت." },
    ...
    { 
        id:24, 
        en:{ place:"New York (USA)", type:"Espionage", desc:"1986 Israeli spy Jonathan Pollard caught selling US secrets to Israel." },
        ar:{ place:"نيويورك (أمريكا)", type:"تجسس", desc:"قضية الجاسوس بولارد ١٩٨٦." },
